...
const OperationLogList: React.FC = () => {
  ...
  const columns: ProColumns<any>[] = [
    ...
    { title: f('entity.log.path'), dataIndex: 'requestUrl', width: 260, hideInSearch: true },
    ...
    { title: f('entity.log.time'), dataIndex: 'createdAt', width: 170, hideInSearch: true },
  ];
  ...
  return (
    <ProTable
      ...
      request={async (params) => {
        const res = await getOperationLogList({ page: params.current || 1, pageSize: params.pageSize || 10, module: params.module, operation: params.operation, operatorName: params.operatorName });
