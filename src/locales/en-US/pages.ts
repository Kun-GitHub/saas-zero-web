export default {
  ...
  'pages.dashboard.loginTotal': 'Total Logins',
  ...
  'pages.dashboard.stat.api': 'API Service',
  'pages.dashboard.stat.database': 'Database',
  'pages.dashboard.stat.cache': 'Cache Service',
  ...
  'pages.tenant.package.search': 'Search name/code',

  'pages.api.title': 'API Management',
  'pages.api.create': 'Create API',
  'pages.api.addChild': 'Add Child',
  ...
  'pages.dict.search': 'Search name/key',
  'pages.dict.data.search': 'Search name/key/value',
  ...
  // App-level (header, avatar dropdown, tabs)
  'app.logout': 'Logout',
  'app.logout.success': 'Logged out successfully',
  'app.profile': 'Profile',
  'app.changePassword': 'Change Password',
  'app.defaultRole': 'User',
  'app.password.old': 'Current Password',
  'app.password.new': 'New Password',
  'app.password.oldRequired': 'Please enter current password',
  'app.password.newRequired': 'Please enter new password',
  'app.password.confirmRequired': 'Please confirm new password',
  'app.password.mismatch': 'Passwords do not match',
  'app.password.success': 'Password changed successfully',
  'app.password.minLength': 'Password must be at least 6 characters',
  'app.tabs.closeOthers': 'Close Other Tabs',
  'app.tabs.closeRight': 'Close Right Tabs',
